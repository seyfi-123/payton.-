...
DAILY_MIN = 200
DAILY_MAX = 2000
STUDENT_MIN = 3000  # ИСЛОҲ: 3000 аз рӯи хатои E1001
STUDENT_MAX = 12000
RENT_MIN = 3000
RENT_MAX = 12000
...
# ИСЛО: Миқдорҳои дуруст барои StudentPay (3000-12000)
STUDENT_AMOUNTS = [
...
# ИСЛОҲ: Миқдорҳои дуруст барои RentPay (3000-12000)
...
def payton_cases() -> list[PaytonCase]:
    ...
    cases.extend([
        PaytonCase("R16", "RentPay invalid product", "VALIDATION", "RentPay", 3000, 216,
                   tweak=set_field("product_type", "RENT_PAY")),
        PaytonCase("R17", "RentPay missing landlord_iban", "REJECTED", "RentPay", 3000, 217,
                   tweak=drop("landlord_iban")),
        PaytonCase("R18", "RentPay empty landlord_iban", "REJECTED", "RentPay", 3000, 218,
                   tweak=set_field("landlord_iban", "")),
        PaytonCase("R19", "RentPay invalid DOB", "VALIDATION", "RentPay", 3000, 219,
                   dob="wrong"),
        PaytonCase("R20", "RentPay invalid self IBAN", "INVALID_IBAN", "RentPay", 3000, 220,
                   self_iban="BAD_IBAN"),
    ])
...
def run_mockjet(label: str, path: str, key: str, body: dict[str, Any]) -> bool:
    ...
    # ИСЛОҲ: 200 ё 404-ро қабул кун (агар endpoint вуҷуд надошта бошад)
